...
export function main(){
  ...
  // at the same time, pass the url to filename generator and store the corresponding filename with urls as the key
  ...
  chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    if (request.action === "getUrlsAndFilenames") {
      console.log("Sending imageUrls and filenames to background:", request);
